...
* Использование TransactionSynchronizationManager для перехвата событий, например afterCommit
* Использование @TransactionalEventListener для перехвата событий, например afterCommit
